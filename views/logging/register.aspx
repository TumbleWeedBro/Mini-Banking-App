<%@ Page Title="" Language="C#" MasterPageFile="~/views/layout.Master" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="Mini_Banking_App.views.logging.register" %>
    ...
    <form id="form1" runat="server" method="post" class="container-fluid">
        <div class="card bg-light">
            <div class="card-body mx-auto" style="max-width: 400px; ">
                <h4 class="card-title mt-3 text-center align-items-center">Create Account</h4>
                <p class="text-center">Get started with an Easy account </p>
                <div class="form" runat="server">
                    ...
                    <div class="form-group input-group">
                        ...
                        <asp:TextBox runat="server" ID="txtPassword" CssClass="form-control" placeholder="Create password" type="password"></asp:TextBox>
                    </div>
                    <div class="form-group input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text"> <i class="fa fa-lock"></i> </span>
                        </div>
                        <asp:TextBox runat="server" ID="txtRepeatPassword" CssClass="form-control" placeholder="Repeat password" type="password"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <asp:Button runat="server" ID="btnCreateAccount" class="btn btn-primary btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;" Text="Create Account" OnClick="btnCreateAccount_Click" />
